<footer class="site-footer">
  <div class="wrap">
    <div class="footer-grid">
      <div class="footer-brand">
        <a href="index.php" class="brand">
          ...
          <span class="brand-text">
            <span class="brand-name" style="color:var(--dark-text);">Gurutma</span>
      ...
      <div class="footer-col">
        <h5>Reach Us</h5>
        <a href="tel:+919810000000" class="footer-contact-link"><svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"></path></svg> +91 98100 00000</a>
        <a href="mailto:info@gurutmafinancial.com" class="footer-contact-link"><svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="2" y="4" width="20" height="16" rx="2"></rect><path d="m22 7-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7"></path></svg> info@gurutmafinancial.com</a>
        <a href="https://wa.me/919810000000" target="_blank" rel="noopener" class="footer-wa-link">
    ...
    <div class="footer-bottom">
      <div class="footer-copy">
        © <span id="year"><?php echo date('Y'); ?></span> Gurutma Financial Services Pvt. Ltd. All rights reserved.
      </div>
      <div class="footer-by">
        Official Registered Financial Services Desk · RBI Conduct Compliant
      </div>
    </div>
  </div>
</footer>
...
<a class="wa-float" href="https://wa.me/919810000000?text=Hi%2C%20I%27d%20like%20to%20know%20more%20about%20your%20services" target="_blank" rel="noopener" aria-label="Chat with us on WhatsApp" title="Chat on WhatsApp">
